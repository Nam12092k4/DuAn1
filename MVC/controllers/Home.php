...
class Home extends Controller
{
  ...
  function Default()
  {
    ...
    $this->view("master1", [
      ...
      "ShowAbout" => $User->ListItem1($user_id),
      "showSale" => $Product->ListItemSale(),
  ...
  function product($id)
  {
    ...
    $this->view("master2", [
      ...
      "showSizeOption" => $Product->showSize($id),
      "showSize2" => $Product->showPrice($id),
      "showBrandId" => $Product->showBrandId($id),
      "ShowMenu" => $Category->ListAll(),
  ...
  function danhmuc($id)
  {
    ...
    $this->view("master2", [
      ...
      "ShowNameUser" => $User->ShowNameUser($user_id),
      "showBrand" => $ProductModel->showBrand(),
    ]);
  }
  function brand($id)
  {
    ...
    $this->view("master2", [
      ...
      "showMenu" => $CategoryModel->ListAll(),
      "ListItemId" => $ProductModel->ListItemId($id),
      "showNumbrand" => $ProductModel->showNumIdBrand($id),
      "ListAllbrand" => $ProductModel->ListAllbrand($id),
      "ShowAbout" => $User->ListItem1($user_id),
      "ShowMenu" => $CategoryModel->ListAll(),
      "ShowName" => $CategoryModel->ListItem($id),
      "ShowNameUser" => $User->ShowNameUser($user_id),
  ...
  function user()
  {
    ...
    $this->view("master3", [
      ...
      "ShowAbout1" => $UserModel->ListItem2($id),
      "ShowNameUser" => $User->ShowNameUser($user_id),
    ]);
  }
