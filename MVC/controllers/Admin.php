...
class Admin extends Controller
{
  ...
  function Default()
  {
    ...
    $this->view("masterAdmin", [
      ...
      "countBrand" => $Category->countBrand(),
  ...
  function editBrand($id)
  {
    ...
    $Category = $this->model("CategoryModel");
    $Category->checkidbrand($id);
    $this->view("masterAdmin", [
      "Page" => "editBrand",
      "ShowEdit" => $Category->ListBrand($id)
    ]);
    if (isset($_POST['name'])) {
      $name = $_POST['name'];
      $Category->editBrand($id, $name);
    }
  }
  ...
  function brand()
  {
    ...
    $Brand = $this->model("CategoryModel");
    $this->view("masterAdmin", [
      "Page" => "brand",
      "ShowBrand" => $Brand->showBrand(),
      "ShowCategory" => $Brand->ListAll()
    ]);
  }
  ...
  function addBrand()
  {
    ...
    $Brand->addBrand($name,$category_id);
  }
