<main class="grid wide container user" style="margin: 80px auto;margin-bottom:50px;">
...
<div class="nhan_container">
    <ul class="tab_navigation">
      <li class="mota active" style="background-color:white;margin-left:40px;">Đăng kí</li>
      <li style="background-color:white;margin-left:40px;"> | </li>
      <li class="danhgia" style="background-color:white;margin-left:40px;">Đăng nhập</li>
    </ul>
    ...
    <div class="btn-login">
        <div>
          <button style="background-color:#474646;border-radius:2px;">Đăng kí</button>
        </div>
    ...
    <div class="tab_container_area" id="danhgia">
      <div class="tab_container">
      <form action="http://localhost/DuAn1/Home/loginAction" method="POST" id="form_login" >
