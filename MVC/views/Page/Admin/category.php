            ...
            <tbody id="tableSearch" >
              ...
              ?>
                <tr class="sortby" >
                  ...
                  <td><a href="<?=BASE_URL?>/Admin/editCategory/<?=$row['category_id']?>" class="btn btn-warning">Edit</a></td>
                  <td><button class="btn-xoa" onclick="deleteCategory(<?=$row['category_id']?>)"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="white" d="M7 21q-.825 0-1.412-.587T5 19V6H4V4h5V3h6v1h5v2h-1v13q0 .825-.587 1.413T17 21zM17 6H7v13h10zM9 17h2V8H9zm4 0h2V8h-2zM7 6v13z"/></svg></button></td>
                </tr>
              <?php
              }
              ?>
