                    ...
                    <select class="form-control" id="exampleFormControlSelect1" name="brand_id">
                        ...
                        while ($row = mysqli_fetch_array($data['ShowBrand'])) {
                            if ($item['brand_id'] == $row['brand_id']) {
                                echo '<option selected value="' . $item['brand_id'] . '">' . $row['name'] . '</option>';
                            } else {
                ...
                <div class="form-group row">
                    ...
                    while ($avt = mysqli_fetch_array($data['ShowVariant'])) {
                        ...
                        <div class="input-group input-group-sm mb-3 col-4 pt-2">
                            ...
                            <input type="text" name="<?= $i ?>" value="<?= $avt['price'] ?>" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
                        </div>
                    <?php
                    }
                    ?>
